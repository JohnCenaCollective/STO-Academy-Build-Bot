...
namespace Emzi0767.Gaming.Sto.AcademyConverterBot.Utilities
{
    public class BuildWriter : IDisposable
    {
        ...
        public void WriteBuild(StoAcademyBuild build, StoAcademyTools tools)
        {
            ...
            this.MDW.WriteParagraph(string.Format("*Academy Bot Version: {0} | LibStoa Version: {1}*", AcademyLib.LibAcademyVersion, AcademyLib.LibBotVersion));
        }
