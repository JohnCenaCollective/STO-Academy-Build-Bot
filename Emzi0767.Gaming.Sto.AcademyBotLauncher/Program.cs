...
namespace Emzi0767.Gaming.Sto.AcademyBotLauncher
{
    internal static class Program
    {
        ...
        internal static void Main(string[] args)
        {
            ...
            var bot = Assemblies.First(kvp => kvp.Value.FullName.Contains("Emzi0767.Gaming.Sto.AcademyConverterBot")).Value;
            var lib = Assemblies.First(kvp => kvp.Value.FullName.Contains("Emzi0767.Gaming.Sto.StoaLib")).Value;

            var bot_cls = bot.GetType("Emzi0767.Gaming.Sto.AcademyConverterBot.AcademyLib");
